...
export default function WhatsAppButton() {
  ...
  const message = "Hi TEKSUM Support, I need help with my account.";
  ...
  return (
    ...
    >
      ...
      >
        ...
        <path d="M12 0C5.373 0 0 5.373 0 12c0 2.117.549 4.099 1.51 5.823L.057 23.535a.75.75 0 00.906.919l5.857-1.533A11.943 11.943 0 0012 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 21.75a9.696 9.696 0 01-4.953-1.356l-.355-.211-3.676.963.981-3.584-.232-.368A9.696 9.696 0 012.25 12C2.25 6.615 6.615 2.25 12 2.25S21.75 6.615 21.75 12 17.385 21.75 12 21.75z" />
      </svg>
    </a>
  );
}