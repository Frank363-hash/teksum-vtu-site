  ...
  return (
    <div className="min-h-screen w-full min-w-0 overflow-x-clip bg-white dark:bg-[#0d1526]">
      ...
      <main className="w-full min-w-0 overflow-x-clip">
        ...
        <section className="w-full overflow-hidden border-y border-[#dbeafe] bg-[#f8fbff] px-4 py-12 sm:px-6 lg:px-8 dark:border-[#1e3a6e] dark:bg-[#0d1526]">
          ...
          <div className="mx-auto w-full max-w-7xl min-w-0">
            ...
            <RevealOnScroll delay={100}>
              <div className="relative mt-8 w-full min-w-0 overflow-hidden rounded-2xl border border-[#dbeafe] bg-white py-4 shadow-sm dark:border-[#1e3a6e] dark:bg-[#152040]">

                <div className="teksum-partner-track flex w-max max-w-none items-center gap-6 px-6">
